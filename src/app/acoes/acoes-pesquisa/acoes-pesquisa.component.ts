...
@Component({
  selector: 'app-acoes-pesquisa',
  templateUrl: './acoes-pesquisa.component.html',
  styleUrls: ['./acoes-pesquisa.component.css']
})
export class AcoesPesquisaComponent implements OnInit {
